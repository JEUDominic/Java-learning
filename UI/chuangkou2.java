...
public class chuangkou2 extends JFrame implements ActionListener{
		...
		public  chuangkou2(){
			...
			name.setBounds(new Rectangle(200, 40, 200, 25));
		
			label2= new JLabel();//name de zi
			setLayout(null);
			label2.setText("<html><p>Name</p></html>");
			label2.setBounds(new Rectangle(100, 0, 120, 100));
			...
			studentID.setBounds(new Rectangle(200, 90, 200, 25));
		
			label2= new JLabel();//ID de zi
			label2.setText("<html><p>ID</p></html>");
			label2.setBounds(new Rectangle(100, 50, 120, 100));
			label2.setFont(new Font("Century Gothic",0, 24));
			label2.setForeground(Color.white);
			tf= new JTextField(10);
			contentPane.add(label2);
			...
			male.setBorder(null);
			female.setContentAreaFilled(false);
			panel.setBounds(new Rectangle(220, 140, 180, 25));
			...
			label2.setBounds(new Rectangle(100, 100, 120, 100));
			label2.setFont(new Font("Century Gothic",0, 24));
			label2.setForeground(Color.white);
			tf= new JTextField(10);
			contentPane.add(label2);
			...
			label4.setBounds(new Rectangle(100, 50, 1000, 25));
			major= new JTextField(50);
			contentPane.add(label4);
			contentPane.add(major);
			major.setBounds(new Rectangle(200, 190, 200, 25));

		
			label2= new JLabel();//major de zi
			label2.setText("<html><p>Major</p></html>");
			label2.setBounds(new Rectangle(100, 150, 120, 100));
			label2.setFont(new Font("Century Gothic",0, 24));
			label2.setForeground(Color.white);
			tf= new JTextField(10);
			contentPane.add(label2);
			...
			label5.setBounds(new Rectangle(100, 50, 1000, 25));
			...
			jc.setBounds(new Rectangle(250, 240, 120, 25));
		
			label2= new JLabel();//Graduation Year de zi
			label2.setText("<html><p>Graduation Year</p></html>");
			label2.setBounds(new Rectangle(100, 200, 120, 100));
			...
			doo.setBounds(new Rectangle(100, 320, 130, 130));
			doo.setBorder(null);
			...
			end.setBounds(new Rectangle(300, 320, 130, 130));
			end.setBorder(null);
			...
			if (actionCommand.equals("next")) {
				if(s.equals("At home")){
						...
						if(male.isSelected()){
							...
							if(Insert.alumni(alumni) > 0) new chenggong();
						}else{
