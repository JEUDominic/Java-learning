...
public class sousuo extends JFrame implements ActionListener{
		...
		private JRadioButton jb1 = new JRadioButton("Student");
//		private JRadioButton jb2 = new JRadioButton("Company");
		...
		public  sousuo(){
			...
			label2= new JLabel();
			setLayout(null);
			label2.setText("<html><p>Search for </p></html>");
			...
			panel.add(this.jb3);
			container.add(panel);
			panel.setBounds(new Rectangle(140, 90, 300, 50));
